...
- В недрах экосистемы Julia реализована специализация программ.
...
- Конечный пользователь может использовать функции, реализованные кем-то
  другим, не осознавая, что "тихой сапой" происходит специализация.
